        ...
        <div className="m-6 grid grid-cols-2 grid-rows-2 gap-12 bg-gray-100">
            ...
            <div className="row-span-2 h-full bg-gray-700">
                ...
                >
                    ...
                    <input type="text" name="img" id="img" value={selectedFile?.name} ref={imgRef} />
                    <input type="text" name="descripion" id="description" ref={descripionRef} />
                    ...
                    <button type="submit" className="px-4 py-2 ml-5 bg-violet-400">
                        Save
                    </button>
                </form>
            </div>
